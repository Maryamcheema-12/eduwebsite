...
const Courses = () => {
  ...
  return (
    <div className="min-h-screen bg-white selection:bg-amber-100">
      ...
      <section ref={heroRef} className="relative pt-36 sm:pt-40 md:pt-56 pb-20 sm:pb-24 md:pb-40 bg-white overflow-hidden perspective-[1500px] px-4 sm:px-5 md:px-6">
        ...
        <div className="container mx-auto px-4 md:px-6 relative z-10">
          <div className="grid lg:grid-cols-2 gap-8 sm:gap-10 md:gap-14 lg:gap-16 items-center">
            <motion.div initial={{ opacity: 0, x: -50 }} animate={{ opacity: 1, x: 0 }} transition={{ duration: 0.8 }} className="max-w-3xl">
              <div className="flex items-center gap-3 sm:gap-4 mb-6 sm:mb-10 md:mb-12">
                <span className="w-10 sm:w-12 md:w-14 h-0.5 sm:h-1 bg-amber-600"></span>
                <span className="text-[8px] sm:text-[9px] md:text-xs font-black uppercase tracking-[0.2em] sm:tracking-[0.25em] md:tracking-[0.3em] text-amber-600">Educational Catalog</span>
              </div>
              <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-black tracking-tight text-slate-900 mb-6 sm:mb-8 md:mb-10 leading-tight">
                Professional <br />
                <span className="text-amber-600 font-black">Curriculums.</span>
              </h1>
              <p className="text-base sm:text-lg md:text-xl lg:text-2xl text-slate-600 font-medium leading-relaxed sm:leading-loose md:leading-relaxed max-w-2xl">
            ...
            <motion.div initial={{ opacity: 0, scale: 0.8, rotateY: 20 }} animate={{ opacity: 1, scale: 1, rotateY: 0 }} transition={{ duration: 1.2 }} className="hidden lg:flex justify-end">
              <div className="relative group">
                ...
                <div className="relative bg-white border border-slate-100 p-10 sm:p-12 md:p-14 rounded-3xl sm:rounded-4xl shadow-2xl max-w-sm">
                  <Award size={56} className="text-amber-600 mb-6 sm:mb-8" />
                  <h3 className="text-2xl sm:text-3xl md:text-4xl font-black text-slate-900 uppercase tracking-tight mb-4 sm:mb-6 leading-tight">Verified Success</h3>
                  <p className="text-slate-600 text-base sm:text-lg font-medium leading-relaxed">
                    Exclusive access to past papers (2012-2025) and QCS 2014 standards included in all modules.
                  </p>
                </div>
              </div>
            </motion.div>
      ...
      {/* --- FILTER INTERFACE --- */}
      <section className="sticky top-0 z-40 bg-white/85 backdrop-blur-2xl border-b border-slate-200/50 py-5 sm:py-6 md:py-10 px-4 sm:px-5 md:px-6">
      ...
      {/* --- COURSE GRID --- */}
      <section className="py-16 sm:py-20 md:py-32 lg:py-40 px-4 sm:px-5 md:px-6">
        <div className="container mx-auto px-4 md:px-6">
      ...
      <section className="px-4 sm:px-5 md:px-6 mb-16 sm:mb-20 md:mb-28 lg:mb-32">
        <div className="container mx-auto bg-slate-950 rounded-2xl sm:rounded-3xl md:rounded-5xl py-16 sm:py-20 md:py-32 lg:py-40 px-6 sm:px-8 md:px-12 lg:px-16 text-center relative overflow-hidden group shadow-2xl">
