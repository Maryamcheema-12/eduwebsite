  ...
  theme: {
  	extend: {
  		...
  		fontSize: {
  			...
  			'5xl': ['48px', { lineHeight: '56px', letterSpacing: '-0.5px' }],
  			'6xl': ['60px', { lineHeight: '72px', letterSpacing: '-0.5px' }],
  			'7xl': ['72px', { lineHeight: '84px', letterSpacing: '-0.5px' }],
  			'8xl': ['96px', { lineHeight: '104px', letterSpacing: '-0.5px' }]
  		},
  		keyframes: {
  			'accordion-down': {
  				from: {
